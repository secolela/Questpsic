const questoesPsicopatologia = [
  {
    pergunta: "De acordo com as aulas, qual o principal foco da Esquizofrenia como Transtorno Psicótico (CID F20)?",
    alternativas: [
      "Exclusivamente alterações na cognição.",
      "Prejuízos na percepção, pensamento, autoexperiência, cognição, volição, afeto e comportamento.",
      "Apenas dificuldades na socialização.",
      "Distúrbios de humor e ansiedade.",
      "Somente alterações na memória de curto prazo."
    ],
    correta: "Prejuízos na percepção, pensamento, autoexperiência, cognição, volição, afeto e comportamento.",
    justificativa: "A esquizofrenia é um transtorno psicótico abrangente que afeta diversas funções psíquicas, conforme o material de aula."
  },
  {
    pergunta: "Segundo a compreensão psicodinâmica freudiana abordada nas aulas, como a libido se relaciona com o desenvolvimento do ego e o surgimento de quadros como a esquizofrenia?",
    alternativas: [
      "A libido é investida apenas em objetos externos, sem relação com o ego.",
      "No narcisismo primário, a libido investe o ego de forma megalômana, e seu recolhimento em situações de grande impacto pode gerar um 'vazio'.",
      "A libido é um conceito irrelevante para a compreensão da esquizofrenia.",
      "O narcisismo primário promove um ego fragilizado, facilitando a eclosão da esquizofrenia.",
      "O investimento de libido em atividades e pessoas impede qualquer recolhimento posterior."
    ],
    correta: "No narcisismo primário, a libido investe o ego de forma megalômana, e seu recolhimento em situações de grande impacto pode gerar um 'vazio'.",
    justificativa: "A aula aborda a compreensão freudiana do narcisismo primário e como o recolhimento da libido em situações traumáticas pode levar a um 'vazio' e contribuir para quadros psicóticos."
  },
  {
    pergunta: "Qual das seguintes opções descreve uma alteração quantitativa da sensopercepção caracterizada pelo aumento das sensações, comum em estados de mania?",
    alternativas: [
      "Hipoestesia",
      "Anestesia",
      "Hiperestesia",
    ...
    justificativa: "Hiperestesia é o aumento das sensações como um todo, sendo comum em estados de mania e em degustadores, conforme o material de estudo."
  },
  {
    pergunta: "Um paciente relata que vê uma faca na mão de uma pessoa, mas na verdade é uma caneta. Como essa alteração sensoperceptiva é classificada?",
    alternativas: [
      "Alucinação",
      "Alucinose",
      "Pseudoalucinação",
    ...
    correta: "Ilusão",
    justificativa: "Ilusão é a percepção distorcida ou falseada de um objeto real, como o exemplo da faca e da caneta."
  },
  {
    pergunta: "Qual o principal objetivo da psicoterapia em pacientes com esquizofrenia, segundo o material de aula?",
    alternativas: [
      "Cura completa da doença, eliminando todos os sintomas psicóticos.",
      "Exclusivamente o manejo da medicação.",
      "Identificar fatores estressores, elaborar recursos para lidar com eles, promover autonomia e auxiliar no manejo de sentimentos, além do apoio familiar.",
      "Apenas reforçar a negação da realidade para o paciente.",
      "Ignorar o papel da família no tratamento."
    ],
    correta: "Identificar fatores estressores, elaborar recursos para lidar com eles, promover autonomia e auxiliar no manejo de sentimentos, além do apoio familiar.",
    justificativa: "A psicoterapia para esquizofrenia foca em diversos aspectos, como o manejo de estressores, autonomia do paciente e o apoio da rede de suporte."
  },
  {
    pergunta: "A desorientação apática ou abúlica é caracterizada pelo desinteresse do sujeito em investir no mundo. Em quais quadros essa desorientação é mais comum?",
    alternativas: [
      "Estados maníacos",
    ...
    correta: "Quadros depressivos",
    justificativa: "A desorientação apática ou abúlica é comum em quadros depressivos, onde há um desinteresse generalizado do sujeito em interagir com o mundo."
  },
  {
    pergunta: "No contexto da volição (ato), qual a definição de estereotipia?",
    alternativas: [
      "Ato intermitente e não monótono.",
      "Ato repetitivo, sem finalidade prática, e monótono.",
      "Desejo irrefreável de atear fogo.",
      "Impulsão por quebrar objetos.",
      "Movimentos complexos com finalidade prática."
    ],
    correta: "Ato repetitivo, sem finalidade prática, e monótono.",
    justificativa: "Estereotipia é um ato repetitivo, sem finalidade prática aparente e de caráter monótono, diferente de tiques ou outros atos complexos."
  },
  {
    pergunta: "Qual a diferença fundamental entre alucinação e pseudoalucinação, de acordo com as aulas?",
    alternativas: [
      "Alucinação é real e pseudoalucinação é imaginária.",
      "Na alucinação, a consciência está preservada; na pseudoalucinação, a consciência sofre algum dano antes do fenômeno.",
      "Alucinação é sempre visual, pseudoalucinação é auditiva.",
      "Pseudoalucinação é mais grave que alucinação.",
      "Não há diferença, são termos sinônimos."
    ],
    correta: "Na alucinação, a consciência está preservada; na pseudoalucinação, a consciência sofre algum dano antes do fenômeno.",
    justificativa: "A pseudoalucinação ocorre quando a consciência sofre algum dano (como torpor ou obnubilação) antes do fenômeno alucinatório, permitindo, por vezes, a crítica do sujeito."
  },
  {
    pergunta: "O Transtorno da Personalidade Antissocial (TPAS), também conhecido como psicopatia (CID F60.2), é caracterizado por:",
    alternativas: [
      "Um padrão persistente de obediência às normas sociais.",
      "Exclusivamente por episódios de ansiedade social.",
      "Um padrão persistente de violação dos direitos dos outros ou normas sociais.",
      "Dificuldade em formar laços afetivos.",
      "Comportamento altruísta e empático."
    ],
    correta: "Um padrão persistente de violação dos direitos dos outros ou normas sociais.",
    justificativa: "O TPAS é definido por um padrão de desrespeito e violação dos direitos alheios e das normas sociais, conforme o material de aula."
  },
  {
    pergunta: "Qual das seguintes causas para o TPAS é mencionada no material de aula, com base na psicanálise objetal de Winnicott?",
    alternativas: [
      "Alterações genéticas exclusivas.",
      "Ambiente familiar superprotetor.",
      "Manutenção de um ambiente pouco favorável ao desenvolvimento da criança, favorecendo reações à frustração em comportamentos antissociais.",
      "Deficiência na produção de dopamina.",
      "Excesso de afeto na infância."
    ],
    correta: "Manutenção de um ambiente pouco favorável ao desenvolvimento da criança, favorecendo reações à frustração em comportamentos antissociais.",
    justificativa: "Winnicott, em sua perspectiva psicanalítica, aborda como um ambiente desfavorável pode levar a comportamentos antissociais como forma de reação à frustração."
  },
  {
    pergunta: "A psicopatia é frequentemente associada a um medo atávico de ser a presa de um predador intraespécie no setting terapêutico. Qual é a reação fisiológica comum gerada por esse medo?",
    alternativas: [
      "Relaxamento muscular.",
      "Diminuição da frequência cardíaca.",
      "Excitação do Sistema Nervoso Autônomo (SNA), como arrepios ou nervosismo.",
      "Aumento da empatia.",
      "Sonolência."
    ],
    correta: "Excitação do Sistema Nervoso Autônomo (SNA), como arrepios ou nervosismo.",
    justificativa: "O material menciona que o medo atávico em psicopatas no setting terapêutico gera excitação do SNA, resultando em reações como arrepios ou nervosismo."
  },
  {
    pergunta: "No contexto da volição (ato), o que caracteriza a dipsomania?",
    alternativas: [
      "Desejo irrefreável de atear fogo.",
      "Impulsão por quebrar objetos.",
      "Impulsão relativa ao consumo periódico de grandes quantidades de bebida alcoólica até a inconsciência.",
      "Desejo sexual por cadáveres.",
      "Ato intermitente e não monótono."
    ],
    correta: "Impulsão relativa ao consumo periódico de grandes quantidades de bebida alcoólica até a inconsciência.",
    justificativa: "Dipsomania é uma impulsão específica para o consumo periódico e excessivo de álcool, levando à inconsciência."
  },
  {
    pergunta: "A psicopatologia, em sua essência, busca compreender a natureza e as causas dos transtornos mentais. Isso a diferencia de qual outra área, cujo foco é o tratamento?",
    alternativas: [
      "Neurociência",
      "Psicofarmacologia",
      "Psicoterapia",
    ...
    correta: "Psicoterapia",
    justificativa: "Enquanto a psicopatologia se concentra na compreensão e etiologia dos transtornos, a psicoterapia visa o tratamento e a intervenção."
  },
  {
    pergunta: "Qual das seguintes alterações da sensopercepção se refere à sensação de movimento e posição do corpo no espaço, proporcionada pela musculatura e ossos?",
    alternativas: [
      "Cenestesia",
      "Cinestesia",
      "Hiperestesia",
    ...
    correta: "Cinestesia",
    justificativa: "Cinestesia é a sensopercepção interna relacionada ao movimento e à posição do corpo no espaço."
  },
  {
    pergunta: "Um paciente com desorientação delirante pode acreditar que habita o lugar de seus delírios. Esse tipo de desorientação é típico de quais estados?",
    alternativas: [
      "Quadros depressivos",
    ...
    correta: "Estados psicóticos",
    justificativa: "A desorientação delirante é uma alteração da orientação comum em estados psicóticos, onde a realidade é moldada pelos delírios do sujeito."
  },
  {
    pergunta: "A Esquizofrenia pode apresentar alterações no ciclo dopaminérgico. Qual a correlação entre o aumento de dopamina e o estado psicótico?",
    alternativas: [
      "Diminuição da dopamina leva ao estado psicótico.",
      "Aumento de dopamina é correlacionado com o estado psicótico.",
      "Não há relação entre dopamina e esquizofrenia.",
      "A dopamina influencia apenas o humor, não a psicose.",
      "Apenas a serotonina está envolvida na esquizofrenia."
    ],
    correta: "Aumento de dopamina é correlacionado com o estado psicótico.",
    justificativa: "O material aponta que a questão biológica na esquizofrenia se relaciona às alterações no ciclo dopaminérgico, com correlação entre aumento de dopamina e estado psicótico."
  },
  {
    pergunta: "Um indivíduo que apresenta anedonia, ou seja, incapacidade de sentir prazer, está com uma alteração em qual função psíquica?",
    alternativas: [
      "Pensamento",
      "Consciência",
      "Afeto",
    ...
    correta: "Afeto",
    justificativa: "Anedonia é uma alteração do afeto, caracterizada pela incapacidade de sentir prazer, fundamental para a vida emocional do indivíduo."
  },
  {
    pergunta: "Qual das seguintes é uma impulsão sexual caracterizada pelo desejo sexual dirigido a animais?",
    alternativas: [
      "Pedofilia",
      "Gerontofilia",
      "Necrofilia",
    ...
    correta: "Zoofilia",
    justificativa: "Zoofilia é a impulsão sexual que envolve o desejo sexual por animais."
  },
  {
    pergunta: "A Agitação Psicomotora, no contexto da volição, é caracterizada por:",
    alternativas: [
      "Diminuição da atividade motora.",
      "Falta de expressão facial.",
      "Aumento acentuado da atividade motora, com movimentos desordenados e incoerentes.",
      "Fala lenta e arrastada.",
      "Capacidade de planejar ações de forma eficaz."
    ],
    correta: "Aumento acentuado da atividade motora, com movimentos desordenados e incoerentes.",
    justificativa: "A agitação psicomotora é um aumento da atividade motora, muitas vezes desordenado e sem um propósito aparente."
  },
  {
    pergunta: "No tratamento do TPAS, o manejo da contratransferência exige psicoterapia intensiva. Além disso, quais são os dois fatores que compõem a tríade para esse manejo?",
    alternativas: [
      "Medicamento e hospitalização.",
      "Terapia ocupacional e musicoterapia.",
      "Teoria e Supervisão.",
      "Aconselhamento familiar e grupos de apoio.",
      "Nenhuma das alternativas."
    ],
    correta: "Teoria e Supervisão.",
    justificativa: "O material menciona que o manejo da contratransferência no TPAS requer psicoterapia intensiva, teoria e supervisão como elementos essenciais."
  },
  {
    pergunta: "Qual a principal característica do conceito de 'consciência clara' no contexto da psicopatologia?",
    alternativas: [
      "Presença de delírios e alucinações.",
      "Estado de torpor e obnubilação.",
      "Capacidade de compreender o mundo e a si mesmo de forma lúcida e orientada.",
      "Amnésia total.",
      "Fuga de ideias e pensamento desorganizado."
    ],
    correta: "Capacidade de compreender o mundo e a si mesmo de forma lúcida e orientada.",
    justificativa: "Consciência clara implica na lucidez e orientação do indivíduo em relação a si mesmo e ao ambiente."
  },
  {
    pergunta: "Uma paciente relata que se sente como se tivesse 'arame no coração' ou 'um rato no cérebro', sem que haja uma causa física. Que tipo de alucinação é essa?",
    alternativas: [
      "Alucinação auditiva",
      "Alucinação visual",
      "Alucinação tátil",
    ...
    correta: "Alucinação cenestésica",
    justificativa: "Alucinações cenestésicas referem-se a sensações viscerais e corporais anômalas, como os exemplos dados."
  },
  {
    pergunta: "A psicopatologia se divide em 'semiologia' e 'sintomatologia'. Qual a relação entre esses dois conceitos?",
    alternativas: [
      "São sinônimos e podem ser usados indistintamente.",
      "Semiologia estuda os sintomas, e sintomatologia estuda os sinais.",
      "Semiologia estuda os sinais e sintomas (a semiotécnica é a investigação), e sintomatologia estuda as alterações em si (os sintomas).",
      "Não há relação, são campos de estudo separados.",
      "Semiologia é o tratamento e sintomatologia é o diagnóstico."
    ],
    correta: "Semiologia estuda os sinais e sintomas (a semiotécnica é a investigação), e sintomatologia estuda as alterações em si (os sintomas).",
    justificativa: "A semiologia se debruça sobre o estudo dos sinais e sintomas e a semiotécnica é a forma de investigá-los, enquanto a sintomatologia se refere aos próprios sintomas e suas manifestações."
  },
  {
    pergunta: "No contexto da esquizofrenia, quais são os sintomas considerados 'positivos'?",
    alternativas: [
      "Apatia e embotamento afetivo.",
      "Delírios e alucinações.",
      "Pobreza de fala e isolamento social.",
      "Anedonia e falta de motivação.",
      "Dificuldade de concentração e memória."
    ],
    correta: "Delírios e alucinações.",
    justificativa: "Sintomas positivos na esquizofrenia são adições à experiência normal, como delírios e alucinações."
  },
  {
    pergunta: "Qual o conceito de 'abolição da capacidade sensoperceptiva', em que o sujeito pode estar em coma, morto ou vegetando?",
    alternativas: [
      "Hipoestesia",
      "Hiperestesia",
      "Anestesia",
    ...
    correta: "Anestesia",
    justificativa: "Anestesia é a ausência total da capacidade sensoperceptiva."
  },
  {
    pergunta: "No que diz respeito à volição (ato), qual a diferença entre estereotipia e maneirismo?",
    alternativas: [
      "Estereotipia é um ato complexo, maneirismo é simples.",
      "Estereotipia é um ato repetitivo e monótono, maneirismo é uma exacerbação afetada de movimentos naturais.",
      "Estereotipia é um tique, maneirismo é uma impulsão.",
      "Não há diferença, são sinônimos.",
      "Estereotipia é intencional, maneirismo é involuntário."
    ],
    correta: "Estereotipia é um ato repetitivo e monótono, maneirismo é uma exacerbação afetada de movimentos naturais.",
    justificativa: "A aula diferencia estereotipia como repetitiva e monótona, enquanto maneirismo é uma forma exagerada e afetada de gestos comuns."
  },
  {
    pergunta: "A ecolalia e a ecopraxia são alterações da linguagem e da volição, respectivamente. Qual a principal característica de cada uma?",
    alternativas: [
      "Ecolalia é a repetição de palavras, ecopraxia é a imitação de gestos.",
      "Ecolalia é a imitação de gestos, ecopraxia é a repetição de palavras.",
      "Ambas são referentes a delírios.",
      "Ambas são referentes a alucinações.",
      "Ecolalia é o mutismo, ecopraxia é a agitação psicomotora."
    ],
    correta: "Ecolalia é a repetição de palavras, ecopraxia é a imitação de gestos.",
    justificativa: "Ecolalia é a repetição automática das últimas palavras ou frases proferidas por outra pessoa, enquanto ecopraxia é a imitação de gestos ou movimentos alheios."
  },
  {
    pergunta: "A rigidez de pensamento e o pensamento em slide (pensamento acelerado e superficial) são alterações de qual função psíquica?",
    alternativas: [
      "Memória",
      "Atenção",
      "Pensamento",
    ...
    correta: "Pensamento",
    justificativa: "A rigidez e o pensamento em slide são exemplos de alterações na forma e velocidade do pensamento, respectivamente."
  },
  {
    pergunta: "Qual das seguintes alterações é um tipo de alucinação em que o sujeito percebe objetos gigantes?",
    alternativas: [
      "Alucinação Lilliputiana",
      "Alucinação Gulliveriana",
      "Alucinação cenestésica",
      "Alucinação cinestésica",
      "Alucinação hipnagógica"
    ],
    correta: "Alucinação Gulliveriana",
    justificativa: "Alucinação Gulliveriana se refere à percepção de objetos em tamanho gigante, em referência ao personagem de Jonathan Swift."
  },
  {
    pergunta: "A abulia e a hipobulia são alterações da volição. Qual a diferença entre elas?",
    alternativas: [
      "Abulia é o aumento da vontade, hipobulia é a diminuição.",
      "Abulia é a diminuição extrema ou ausência de vontade, hipobulia é a diminuição moderada.",
      "Ambas são sinônimos de agitação psicomotora.",
      "Abulia é a impulsão, hipobulia é a compulsão.",
      "Não há diferença significativa."
    ],
    correta: "Abulia é a diminuição extrema ou ausência de vontade, hipobulia é a diminuição moderada.",
    justificativa: "Abulia é a ausência ou extrema diminuição da vontade, enquanto hipobulia é uma diminuição mais moderada da mesma."
  },
  {
    pergunta: "Em relação aos sintomas da esquizofrenia, o que são considerados sintomas 'negativos'?",
    alternativas: [
      "Alucinações e delírios.",
      "Comportamentos bizarros e fala desorganizada.",
      "Apatia, embotamento afetivo, pobreza de fala, anedonia e isolamento social.",
      "Agitação psicomotora e impulsividade.",
      "Pensamentos obsessivos e compulsões."
    ],
    correta: "Apatia, embotamento afetivo, pobreza de fala, anedonia e isolamento social.",
    justificativa: "Sintomas negativos da esquizofrenia são a ausência ou redução de funções normais, como apatia, anedonia, etc."
  },
  {
    pergunta: "A Catatonia é uma alteração psicomotora na esquizofrenia. Quais são suas principais manifestações?",
    alternativas: [
      "Fala rápida e incoerente.",
      "Aumento da energia e impulsividade.",
      "Ausência de movimento, mutismo, negativismo, flexibilidade cérea, estupor, catalepsia e obediência automática.",
      "Risos inapropriados e choro incontrolável.",
      "Pensamentos repetitivos e compulsivos."
    ],
    correta: "Ausência de movimento, mutismo, negativismo, flexibilidade cérea, estupor, catalepsia e obediência automática.",
    justificativa: "A catatonia é um complexo de sintomas que incluem ausência de movimento, mutismo, negativismo e outras alterações motoras."
  },
  {
    pergunta: "Qual das seguintes alterações da atenção é caracterizada pela diminuição da capacidade de concentração?",
    alternativas: [
      "Hiperprosexia",
      "Aprosexia",
      "Hipoprosexia",
    ...
    justificativa: "Hipoprosexia é a diminuição da capacidade de atenção e concentração."
  },
  {
    pergunta: "O que é 'discurso tangencial' no contexto das alterações da linguagem?",
    alternativas: [
      "Fala rápida e ininterrupta.",
      "Respostas que se afastam do tema da pergunta, sem retornar a ele.",
      "Repetição de palavras ou frases.",
      "Dificuldade em encontrar palavras.",
      "Fala sem sentido lógico."
    ],
    correta: "Respostas que se afastam do tema da pergunta, sem retornar a ele.",
    justificativa: "O discurso tangencial é caracterizado por respostas que se desviam do tópico principal sem voltar a ele, ao contrário do discurso circunstancial que eventualmente retorna."
  },
  {
    pergunta: "A paramnésia e a confabulação são alterações da memória. Qual a diferença entre elas?",
    alternativas: [
      "Paramnésia é a perda total da memória, confabulação é a falsificação da memória.",
      "Paramnésia é a distorção da memória (como déjà vu), confabulação é a invenção de fatos para preencher lacunas da memória.",
      "Paramnésia é a memória de curto prazo, confabulação é a memória de longo prazo.",
      "São sinônimos.",
      "Paramnésia é a lembrança de eventos futuros, confabulação é a lembrança de eventos passados."
    ],
    correta: "Paramnésia é a distorção da memória (como déjà vu), confabulação é a invenção de fatos para preencher lacunas da memória.",
    justificativa: "Paramnésias são distorções da memória (ex: déjà vu), enquanto a confabulação é a criação de memórias falsas para compensar déficits de memória."
  },
  {
    pergunta: "Um indivíduo que apresenta medo irracional e incontrolável de elevadores, mesmo sabendo que não há perigo real, está com uma alteração em qual função psíquica, especificamente em relação ao afeto?",
    alternativas: [
      "Mania",
      "Fobia",
      "Depressão",
    ...
    correta: "Fobia",
    justificativa: "Fobia é um tipo de ansiedade caracterizada por um medo irracional e persistente de um objeto ou situação específica."
  },
  {
    pergunta: "A síndrome de Capgras é uma alteração da sensopercepção e do pensamento, caracterizada pela crença delirante de que:",
    alternativas: [
      "Seus próprios pensamentos não são seus.",
      "Pessoas próximas foram substituídas por impostores idênticos.",
      "Seres extraterrestres estão controlando sua mente.",
      "Ele é uma figura religiosa importante.",
      "Seu corpo está se desintegrando."
    ],
    correta: "Pessoas próximas foram substituídas por impostores idênticos.",
    justificativa: "A síndrome de Capgras é um delírio de identificação errônea, onde o indivíduo acredita que pessoas conhecidas foram substituídas por sósias."
  },
  {
    pergunta: "Qual a diferença entre um delírio primário e um delírio secundário?",
    alternativas: [
      "Delírio primário é contagioso, delírio secundário não.",
      "Delírio primário surge de forma súbita e inexplicável, delírio secundário surge de outros sintomas ou alterações psíquicas.",
      "Delírio primário é sempre religioso, delírio secundário é de perseguição.",
      "Não há diferença, são sinônimos.",
      "Delírio primário é menos grave que delírio secundário."
    ],
    correta: "Delírio primário surge de forma súbita e inexplicável, delírio secundário surge de outros sintomas ou alterações psíquicas.",
    justificativa: "Delírios primários são irredutíveis e surgem sem causa aparente, enquanto delírios secundários são compreensíveis a partir de outros sintomas ou alterações do estado mental."
  },
  {
    pergunta: "No contexto da psicopatologia, o que é 'compulsão'?",
    alternativas: [
      "Um pensamento repetitivo e intrusivo.",
      "Um medo irracional e incontrolável.",
      "Um ato repetitivo e ritualístico realizado para diminuir a ansiedade causada por uma obsessão.",
      "Um desejo sexual desviante.",
      "Um estado de euforia e grandiosidade."
    ],
    correta: "Um ato repetitivo e ritualístico realizado para diminuir a ansiedade causada por uma obsessão.",
    justificativa: "Compulsões são comportamentos repetitivos e ritualísticos realizados para aliviar a ansiedade gerada por obsessões."
  },
  {
    pergunta: "A fuga de ideias é uma alteração do pensamento caracterizada por:",
    alternativas: [
      "Rigidez do pensamento e dificuldade em mudar de assunto.",
      "Pensamento lento e com bloqueios.",
      "Associações rápidas e superficiais entre ideias, sem um encadeamento lógico claro.",
      "Repetição de uma mesma ideia ou frase.",
      "Ausência de pensamento."
    ],
    correta: "Associações rápidas e superficiais entre ideias, sem um encadeamento lógico claro.",
    justificativa: "Fuga de ideias é um fluxo de pensamento acelerado, com mudanças rápidas de um tópico para outro, mas com associações superficiais."
  },
  {
    pergunta: "Qual a principal função da 'orientação autopsíquica'?",
    alternativas: [
      "Conhecimento do sujeito sobre o tempo e o espaço.",
      "Conhecimento do sujeito sobre sua idade, quem é, nome e profissão.",
      "Capacidade de interagir socialmente.",
      "Habilidade de planejar o futuro.",
      "Percepção de estímulos sensoriais."
    ],
    correta: "Conhecimento do sujeito sobre sua idade, quem é, nome e profissão.",
    justificativa: "A orientação autopsíquica refere-se ao conhecimento do indivíduo sobre sua própria identidade."
  },
  {
    pergunta: "Um indivíduo que apresenta alucinações onde ouve vozes que o mandam fazer coisas está com qual tipo de alucinação, e qual sua característica principal?",
    alternativas: [
      "Alucinação visual, caracterizada por visões.",
      "Alucinação olfativa, caracterizada por cheiros inexistentes.",
      "Alucinação auditiva, caracterizada pela percepção de sons ou vozes sem estímulo externo real.",
      "Alucinação tátil, caracterizada por sensações de toque.",
      "Alucinação gustativa, caracterizada por sabores inexistentes."
    ],
    correta: "Alucinação auditiva, caracterizada pela percepção de sons ou vozes sem estímulo externo real.",
    justificativa: "As alucinações auditivas são comuns na esquizofrenia e envolvem a percepção de sons ou vozes que não existem na realidade."
  },
  {
    pergunta: "Qual das seguintes alterações da volição é caracterizada por um desejo irrefreável de atear fogo?",
    alternativas: [
      "Dipsomania",
      "Frangofilia",
      "Piromania",
    ...
    correta: "Piromania",
    justificativa: "Piromania é a impulsão específica para atear fogo."
  },
  {
    pergunta: "No contexto da esquizofrenia, o que significa 'embotamento afetivo'?",
    alternativas: [
      "Expressão de emoções de forma exagerada.",
      "Dificuldade em controlar a raiva.",
      "Redução ou ausência de expressão emocional, como falta de reatividade afetiva e empobrecimento das emoções.",
      "Sentimentos de alegria e euforia constantes.",
      "Oscilações rápidas de humor."
    ],
    correta: "Redução ou ausência de expressão emocional, como falta de reatividade afetiva e empobrecimento das emoções.",
    justificativa: "O embotamento afetivo é a diminuição ou ausência de expressividade emocional, um sintoma negativo da esquizofrenia."
  },
  {
    pergunta: "A psicopatologia fenomenológica, ao contrário da psicopatologia médica tradicional, busca compreender o que?",
    alternativas: [
      "Exclusivamente a etiologia biológica dos transtornos.",
      "A experiência subjetiva do sofrimento mental do indivíduo.",
      "A classificação e o diagnóstico dos transtornos com base em critérios objetivos.",
      "O tratamento farmacológico dos sintomas.",
      "Apenas os aspectos sociais dos transtornos."
    ],
    correta: "A experiência subjetiva do sofrimento mental do indivíduo.",
    justificativa: "A psicopatologia fenomenológica prioriza a compreensão da vivência e do significado do sofrimento para o indivíduo, além da simples descrição dos sintomas."
  },
  {
    pergunta: "O que é 'hipomnésia' no contexto das alterações da memória?",
    alternativas: [
      "Aumento da capacidade de memória.",
      "Perda total da memória.",
      "Diminuição da capacidade de memória.",
      "Falsificação da memória.",
      "Lembrança de eventos futuros."
    ],
    correta: "Diminuição da capacidade de memória.",
    justificativa: "Hipomnésia é a diminuição da capacidade de reter ou evocar informações."
  },
  {
    pergunta: "Qual das seguintes é uma impulsão sexual que se refere ao desejo sexual por cadáveres?",
    alternativas: [
      "Pedofilia",
      "Zoofilia",
      "Gerontofilia",
    ...
    correta: "Necrofilia",
    justificativa: "Necrofilia é a impulsão sexual específica pelo desejo de cadáveres."
  },
  {
    pergunta: "Um indivíduo que apresenta uma visão em que os dedos de suas mãos se transformam em cobras, mesmo com os dedos presentes, está tendo que tipo de alteração sensoperceptiva?",
    alternativas: [
      "Pseudoalucinação",
      "Ilusão",
      "Alucinação com um objeto já presente",
      "Alucinose",
      "Delírio"
    ],
    correta: "Alucinação com um objeto já presente",
    justificativa: "O material menciona que pessoas podem alucinar com um objeto já presente, dando o exemplo de dedos se transformando em cobras."
  },
  {
    pergunta: "A desorientação devido a 'déficit de memória imediata' ocorre porque o sujeito não consegue:",
    alternativas: [
      "Lembrar de eventos passados.",
      "Fixar conteúdos, perdendo a fluência do tempo e espaço.",
      "Reconhecer pessoas.",
      "Planejar suas ações.",
      "Expressar seus sentimentos."
    ],
    correta: "Fixar conteúdos, perdendo a fluência do tempo e espaço.",
    justificativa: "O déficit de memória imediata impede a fixação de novos conteúdos, resultando em desorientação temporal e espacial."
  },
  {
    pergunta: "Qual a função do 'sumário de codificação' no contexto da avaliação psicopatológica?",
    alternativas: [
      "Diagnosticar transtornos mentais.",
      "Registrar os sintomas e sinais observados no paciente de forma organizada.",
      "Definir o plano de tratamento.",
      "Realizar a anamnese do paciente.",
      "Classificar o paciente em categorias específicas."
    ],
    correta: "Registrar os sintomas e sinais observados no paciente de forma organizada.",
    justificativa: "O sumário de codificação é uma ferramenta para organizar e registrar as informações coletadas durante a avaliação psicopatológica."
  },
  {
    pergunta: "Um paciente que apresenta 'estereotipia verbal', ou seja, repetição de palavras ou frases sem sentido aparente, está com uma alteração em qual função psíquica?",
    alternativas: [
      "Memória",
      "Orientação",
      "Linguagem",
    ...
    correta: "Linguagem",
    justificativa: "Estereotipia verbal é uma alteração da linguagem que envolve a repetição de sons, palavras ou frases de forma persistente e sem sentido."
  },
  {
    pergunta: "Qual das seguintes alternativas descreve a 'aprosodia' como alteração da linguagem?",
    alternativas: [
      "Perda da capacidade de produzir fala.",
      "Dificuldade em compreender a linguagem.",
      "Perda da capacidade de variar a entonação, o ritmo e o volume da fala.",
      "Repetição de palavras ou frases de outros.",
      "Uso de neologismos."
    ],
    correta: "Perda da capacidade de variar a entonação, o ritmo e o volume da fala.",
    justificativa: "Aprosodia é a dificuldade ou incapacidade de expressar ou compreender as nuances emocionais e prosódicas da fala."
  },
  {
    pergunta: "A psicopatologia, para Dalgalarrondo (2009), é a 'semiologia dos transtornos mentais'. O que isso significa?",
    alternativas: [
      "A psicopatologia trata os transtornos mentais.",
      "A psicopatologia estuda os aspectos genéticos dos transtornos.",
      "A psicopatologia é o estudo dos sinais e sintomas dos transtornos mentais, visando sua identificação e compreensão.",
      "A psicopatologia é sinônimo de neurologia.",
      "A psicopatologia se limita à prevenção de doenças mentais."
    ],
    correta: "A psicopatologia é o estudo dos sinais e sintomas dos transtornos mentais, visando sua identificação e compreensão.",
    justificativa: "A semiologia dos transtornos mentais implica no estudo e na descrição dos sinais e sintomas para a compreensão das manifestações das doenças mentais."
  },
  {
    pergunta: "Qual a importância da 'autoexperiência' na compreensão da esquizofrenia, segundo o material de aula?",
    alternativas: [
      "É irrelevante para o diagnóstico.",
      "Refere-se apenas à experiência física do paciente.",
      "Está ligada à forma como o indivíduo se percebe e se relaciona com sua própria identidade, sendo afetada na esquizofrenia.",
      "Determina a escolha do tratamento medicamentoso.",
      "Não é um prejuízo na esquizofrenia."
    ],
    correta: "Está ligada à forma como o indivíduo se percebe e se relaciona com sua própria identidade, sendo afetada na esquizofrenia.",
    justificativa: "A autoexperiência é um dos domínios afetados na esquizofrenia, referindo-se à percepção do eu e da identidade."
  },
  {
    pergunta: "A 'abulia' é a diminuição extrema ou ausência de vontade. Em que tipo de quadros clínicos ela é mais frequentemente observada?",
    alternativas: [
      "Transtorno Bipolar (fase maníaca)",
      "Transtorno de Ansiedade Generalizada",
      "Quadros depressivos graves e esquizofrenia (sintomas negativos).",
      "Transtorno Obsessivo-Compulsivo",
      "Transtorno da Personalidade Antissocial."
    ],
    correta: "Quadros depressivos graves e esquizofrenia (sintomas negativos).",
    justificativa: "A abulia é um sintoma proeminente em quadros depressivos graves e como um sintoma negativo na esquizofrenia, indicando uma perda significativa da motivação."
  },
  {
    pergunta: "O que é 'alogia' no contexto dos sintomas negativos da esquizofrenia?",
    alternativas: [
      "Aumento da fala.",
      "Fala rápida e incoerente.",
      "Pobreza de fala, caracterizada por respostas breves e sem conteúdo.",
      "Repetição de palavras de outros.",
      "Invenção de novas palavras."
    ],
    correta: "Pobreza de fala, caracterizada por respostas breves e sem conteúdo.",
    justificativa: "Alogia é a pobreza de fala, um sintoma negativo da esquizofrenia, onde a produção da fala é escassa e sem conteúdo."
  },
  {
    pergunta: "Qual o papel do 'afeto' na psicopatologia?",
    alternativas: [
      "Referir-se apenas à inteligência do indivíduo.",
      "Descrever as emoções e o humor do indivíduo, bem como sua capacidade de expressá-los.",
      "Avaliar a memória de curto prazo.",
      "Determinar a orientação temporal e espacial.",
      "Indicar a presença de delírios."
    ],
    correta: "Descrever as emoções e o humor do indivíduo, bem como sua capacidade de expressá-los.",
    justificativa: "O afeto na psicopatologia se refere às expressões e vivências emocionais do indivíduo, incluindo humor, emoções e sua capacidade de modulação."
  },
  {
    pergunta: "No transtorno da personalidade antissocial, a impulsividade é uma característica marcante. Como ela geralmente se reflete?",
    alternativas: [
      "Por direções prudentes e planejamento de atos.",
      "Por atitudes de reflexão antes da ação.",
      "Por direções imprudentes e baixo planejamento dos atos.",
      "Pela busca de segurança e estabilidade.",
      "Pela capacidade de adiar gratificações."
    ],
    correta: "Por direções imprudentes e baixo planejamento dos atos.",
    justificativa: "A impulsividade no TPAS leva a ações precipitadas e sem planejamento, como direções imprudentes."
  },
  {
    pergunta: "Qual a diferença entre 'orientação autopsíquica' e 'orientação alopsíquica'?",
    alternativas: [
      "Autopsíquica é sobre o tempo, alopsíquica é sobre o espaço.",
      "Autopsíquica é sobre si mesmo, alopsíquica é sobre o mundo (tempo e espaço).",
      "Autopsíquica é sobre a memória, alopsíquica é sobre a atenção.",
      "São sinônimos, referem-se à mesma coisa.",
      "Autopsíquica é sobre os delírios, alopsíquica é sobre as alucinações."
    ],
    correta: "Autopsíquica é sobre si mesmo, alopsíquica é sobre o mundo (tempo e espaço).",
    justificativa: "A orientação autopsíquica se refere ao conhecimento de si, enquanto a alopsíquica diz respeito à relação do sujeito com o ambiente (tempo e espaço)."
  },
  {
    pergunta: "A psicoterapia em pacientes com esquizofrenia pode sugerir temas, estimular a participação e organizar a conversa. O que isso indica sobre o papel do terapeuta?",
    alternativas: [
      "O terapeuta deve ser passivo e apenas ouvir.",
      "O terapeuta deve ser ativo e coordenar a sessão.",
      "O terapeuta deve apenas medicar o paciente.",
      "O terapeuta deve ignorar os temas do paciente.",
      "O terapeuta deve apenas validar os delírios do paciente."
    ],
    correta: "O terapeuta deve ser ativo e coordenar a sessão.",
    justificativa: "O material enfatiza a necessidade de um terapeuta ativo na psicoterapia para esquizofrenia, que monitore, sugira e organize a sessão."
  },
  {
    pergunta: "O que é 'alucinose' no contexto das alterações da sensopercepção?",
    alternativas: [
      "É um tipo de delírio.",
      "Percepção distorcida de um objeto real.",
      "Alucinação que o sujeito critica, sabe que não é real.",
      "Percepção de algo que não existe, mas com crítica da realidade, geralmente devido a lesões orgânicas cerebrais.",
      "Sintoma comum em quadros depressivos."
    ],
    correta: "Percepção de algo que não existe, mas com crítica da realidade, geralmente devido a lesões orgânicas cerebrais.",
    justificativa: "Alucinose é uma alucinação em que o paciente mantém a crítica da realidade, sabendo que a percepção não é real, e geralmente é de causa orgânica."
  },
  {
    pergunta: "Qual a diferença entre 'delírio de perseguição' e 'delírio de referência'?",
    alternativas: [
      "Delírio de perseguição é sobre ser observado, delírio de referência é sobre ser alvo de ataque.",
      "Delírio de perseguição é a crença de estar sendo prejudicado, delírio de referência é a crença de que eventos neutros têm um significado pessoal.",
      "São sinônimos.",
      "Delírio de perseguição é religioso, delírio de referência é de grandeza.",
      "Delírio de perseguição é contagioso, delírio de referência não."
    ],
    correta: "Delírio de perseguição é a crença de estar sendo prejudicado, delírio de referência é a crença de que eventos neutros têm um significado pessoal.",
    justificativa: "Delírio de perseguição envolve a crença de ser prejudicado, enquanto o delírio de referência atribui significados pessoais a eventos externos neutros."
  },
  {
    pergunta: "A 'esquizofrenia hebefrênica' (desorganizada) é caracterizada principalmente por:",
    alternativas: [
      "Sintomas catatônicos predominantes.",
      "Delírios de perseguição sistematizados.",
      "Discurso e comportamento desorganizados, afeto inapropriado e embotado.",
      "Sintomas negativos proeminentes.",
      "Foco em alucinações auditivas."
    ],
    correta: "Discurso e comportamento desorganizados, afeto inapropriado e embotado.",
    justificativa: "A esquizofrenia hebefrênica é marcada por desorganização no pensamento, fala e comportamento, além de afeto inadequado."
  },
  {
    pergunta: "A 'amnésia retrógrada' e a 'amnésia anterógrada' são tipos de amnésia. Qual a diferença entre elas?",
    alternativas: [
      "Retrógrada é a perda da memória para eventos futuros, anterógrada para eventos passados.",
      "Retrógrada é a perda da memória para eventos passados, anterógrada é a perda da memória para eventos futuros (novas informações).",
      "Ambas são perdas totais da memória.",
      "Retrógrada é transitória, anterógrada é permanente.",
      "Não há diferença, são sinônimos."
    ],
    correta: "Retrógrada é a perda da memória para eventos passados, anterógrada é a perda da memória para eventos futuros (novas informações).",
    justificativa: "A amnésia retrógrada impede a lembrança de eventos anteriores ao trauma, enquanto a anterógrada impede a formação de novas memórias."
  },
  {
    pergunta: "O 'tique' no contexto da volição é descrito como:",
    alternativas: [
      "Um ato complexo e proposital.",
      "Um ato intermitente, sem finalidade prática, mas não monótono.",
      "Um desejo incontrolável de quebrar objetos.",
      "Uma repetição monótona de movimentos.",
      "Um comportamento sempre agressivo."
    ],
    correta: "Um ato intermitente, sem finalidade prática, mas não monótono.",
    justificativa: "Tiques são atos intermitentes, sem finalidade prática, e não são monótonos, diferentemente das estereotipias."
  },
  {
    pergunta: "Qual a importância da 'cognição' como função psíquica na psicopatologia?",
    alternativas: [
      "Está ligada apenas à capacidade física do indivíduo.",
      "Refere-se aos processos de pensamento, raciocínio, memória, atenção e percepção, sendo fundamental para o funcionamento mental.",
      "Não é relevante para o diagnóstico de transtornos mentais.",
      "Determina exclusivamente o humor do paciente.",
      "Está relacionada apenas à expressão de emoções."
    ],
    correta: "Refere-se aos processos de pensamento, raciocínio, memória, atenção e percepção, sendo fundamental para o funcionamento mental.",
    justificativa: "A cognição abrange diversos processos mentais essenciais para o funcionamento do indivíduo, como pensamento, memória, atenção e percepção."
  },
  {
    pergunta: "A 'paraprosexia' é uma alteração da atenção que se manifesta como:",
    alternativas: [
      "Aumento da atenção em vários estímulos ao mesmo tempo.",
      "Diminuição da atenção seletiva.",
      "Variação da atenção, com momentos de hiperprosexia e hipoprosexia.",
      "Impossibilidade de fixar a atenção.",
      "Aumento da capacidade de concentração."
    ],
    correta: "Variação da atenção, com momentos de hiperprosexia e hipoprosexia.",
    justificativa: "Paraprosexia é a instabilidade da atenção, com flutuações entre aumento e diminuição da capacidade de concentração."
  },
  {
    pergunta: "Em relação ao tratamento da esquizofrenia, o apoio da família (ou rede de apoio) é considerado:",
    alternativas: [
      "Irrelevante.",
      "De extrema importância.",
      "Prejudicial ao paciente.",
      "Importante apenas na fase inicial do tratamento.",
      "Recomendado apenas em casos leves."
    ],
    correta: "De extrema importância.",
    justificativa: "O material destaca a importância do apoio familiar e da rede de suporte para a boa evolução do paciente com esquizofrenia."
  },
  {
    pergunta: "Qual das seguintes frases descreve a 'esquizofrenia indiferenciada'?",
    alternativas: [
      "Predominância de sintomas catatônicos.",
      "Presença de delírios sistematizados de perseguição.",
      "Diagnóstico quando os sintomas não se encaixam claramente em nenhum outro tipo de esquizofrenia ou quando há mistura de sintomas de vários tipos.",
      "Ausência de sintomas negativos.",
      "Foco principal em alucinações olfativas."
    ],
    correta: "Diagnóstico quando os sintomas não se encaixam claramente em nenhum outro tipo de esquizofrenia ou quando há mistura de sintomas de vários tipos.",
    justificativa: "A esquizofrenia indiferenciada é diagnosticada quando os sintomas não se encaixam em um tipo específico ou há uma combinação de sintomas de diferentes tipos."
  },
  {
    pergunta: "A 'coprolalia' e a 'copraxia' são alterações da linguagem e da volição, respectivamente. O que elas envolvem?",
    alternativas: [
      "Repetição de palavras de outros.",
      "Uso de linguagem obscena e gestos obscenos.",
      "Dificuldade em compreender a linguagem.",
      "Mutismo e imobilidade.",
      "Invenção de novas palavras."
    ],
    correta: "Uso de linguagem obscena e gestos obscenos.",
    justificativa: "Coprolalia é a emissão involuntária de palavras obscenas, e copraxia é a realização de gestos obscenos."
  },
  {
    pergunta: "O que é 'neologismo' no contexto das alterações da linguagem?",
    alternativas: [
      "Repetição de palavras existentes.",
      "Criação de novas palavras ou frases sem sentido para o ouvinte.",
      "Dificuldade em articular palavras.",
      "Fala acelerada e incoerente.",
      "Mutismo."
    ],
    correta: "Criação de novas palavras ou frases sem sentido para o ouvinte.",
    justificativa: "Neologismos são a criação de novas palavras ou o uso distorcido de palavras existentes, que só fazem sentido para o próprio indivíduo."
  },
  {
    pergunta: "O que é 'hipoprosexia' e em quais condições clínicas ela é frequentemente observada?",
    alternativas: [
      "Aumento da atenção, comum em mania.",
      "Diminuição da atenção, comum em depressão e quadros demenciais.",
      "Abolição da atenção, comum em coma.",
      "Atenção seletiva exagerada, comum em transtornos de ansiedade.",
      "Distração constante, comum em TDAH."
    ],
    correta: "Diminuição da atenção, comum em depressão e quadros demenciais.",
    justificativa: "A hipoprosexia é a diminuição da capacidade de atenção e concentração, frequentemente associada a depressão e demências."
  },
  {
    pergunta: "No contexto da volição (ato), o que é 'compulsão sexual'?",
    alternativas: [
      "Falta de desejo sexual.",
      "Desejo sexual direcionado a um parceiro único.",
      "Impulso irresistível e repetitivo para realizar atos sexuais, muitas vezes sem controle e com prejuízos.",
      "Desejo sexual apenas em fantasias.",
      "Desejo sexual com finalidade reprodutiva."
    ],
    correta: "Impulso irresistível e repetitivo para realizar atos sexuais, muitas vezes sem controle e com prejuízos.",
    justificativa: "Compulsão sexual é um impulso incontrolável para comportamentos sexuais repetitivos, causando sofrimento ou prejuízo."
  },
  {
    pergunta: "Qual a diferença entre 'alogia' e 'mutismo'?",
    alternativas: [
      "Alogia é a ausência de fala, mutismo é a pobreza de fala.",
      "Alogia é a pobreza de fala, mutismo é a ausência total ou quase total de fala.",
      "São sinônimos, referem-se à mesma coisa.",
      "Alogia é a fala acelerada, mutismo é a fala lenta.",
      "Alogia é a repetição de palavras, mutismo é a imitação de gestos."
    ],
    correta: "Alogia é a pobreza de fala, mutismo é a ausência total ou quase total de fala.",
    justificativa: "Alogia é a diminuição da quantidade de fala, enquanto o mutismo é a ausência completa ou quase completa da fala."
  },
  {
    pergunta: "A 'síndrome de Cotard' é uma alteração do pensamento (delírio) onde o indivíduo acredita que:",
    alternativas: [
      "É uma figura importante ou grandiosa.",
      "Está sendo perseguido por inimigos.",
      "Morreu, está morto, ou perdeu órgãos internos ou sua própria identidade.",
      "Seus pensamentos estão sendo controlados por forças externas.",
      "Seus familiares foram substituídos por impostores."
    ],
    correta: "Morreu, está morto, ou perdeu órgãos internos ou sua própria identidade.",
    justificativa: "A síndrome de Cotard é um delírio niilista onde o indivíduo acredita estar morto, em processo de decomposição, ou que perdeu órgãos e a identidade."
  },
  {
    pergunta: "Qual o papel do 'comportamento' na psicopatologia da esquizofrenia?",
    alternativas: [
      "É sempre organizado e proposital.",
      "Não é afetado na esquizofrenia.",
      "Pode ser desorganizado, bizarro, com estereotipias, maneirismos ou agitação psicomotora.",
      "Refere-se apenas à interação social.",
      "Está relacionado exclusivamente à fala do paciente."
    ],
    correta: "Pode ser desorganizado, bizarro, com estereotipias, maneirismos ou agitação psicomotora.",
    justificativa: "O comportamento na esquizofrenia pode apresentar diversas alterações, incluindo desorganização e movimentos anormais."
  },
  {
    pergunta: "No contexto da psicopatologia, o que é 'hipocondria'?",
    alternativas: [
      "Medo irracional de altura.",
      "Preocupação excessiva com a própria saúde e a crença de ter doenças graves, mesmo sem evidência médica.",
      "Transtorno alimentar.",
      "Impulso de roubar objetos.",
      "Desejo de atear fogo."
    ],
    correta: "Preocupação excessiva com a própria saúde e a crença de ter doenças graves, mesmo sem evidência médica.",
    justificativa: "Hipocondria é a preocupação persistente e irracional com a saúde e a crença em ter uma doença grave, apesar da ausência de achados médicos."
  },
  {
    pergunta: "O 'bloqueio de pensamento' é uma alteração que se caracteriza por:",
    alternativas: [
      "Aceleração do pensamento.",
      "Interrupção súbita do fluxo do pensamento, com o indivíduo ficando 'em branco'.",
      "Rigidez do pensamento e dificuldade em mudar de tema.",
      "Repetição de uma mesma ideia.",
      "Organização excessiva do pensamento."
    ],
    correta: "Interrupção súbita do fluxo do pensamento, com o indivíduo ficando 'em branco'.",
    justificativa: "O bloqueio de pensamento é a interrupção abrupta do fluxo de ideias, com a mente do indivíduo ficando 'em branco'."
  },
  {
    pergunta: "A psicopatologia, em sua abordagem mais ampla, considera fatores biológicos, psicológicos e sociais na origem dos transtornos mentais. Qual a importância dessa visão?",
    alternativas: [
      "Reduz a compreensão a uma única causa.",
      "Permite uma compreensão mais completa e integrativa da doença mental.",
      "Ignora a complexidade do ser humano.",
      "Prioriza apenas o tratamento medicamentoso.",
      "Foca somente no passado do indivíduo."
    ],
    correta: "Permite uma compreensão mais completa e integrativa da doença mental.",
    justificativa: "A visão biopsicossocial é fundamental para uma compreensão holística dos transtornos mentais, reconhecendo a interação de diversos fatores."
  },
  {
    pergunta: "Qual o conceito de 'despersonalização' no contexto da autoexperiência?",
    alternativas: [
      "Sensação de ser outra pessoa.",
      "Sensação de que o próprio corpo ou os processos mentais não são reais ou não pertencem ao indivíduo.",
      "Perda da identidade pessoal.",
      "Esquecimento de eventos passados.",
      "Dificuldade em reconhecer faces."
    ],
    correta: "Sensação de que o próprio corpo ou os processos mentais não são reais ou não pertencem ao indivíduo.",
    justificativa: "Despersonalização é uma alteração da autoexperiência onde o indivíduo sente-se separado de seu corpo ou de seus processos mentais."
  },
  {
    pergunta: "A 'fala desorganizada' é um sintoma comum na esquizofrenia. Quais são suas características?",
    alternativas: [
      "Discurso coerente e lógico.",
      "Fala monótona e sem expressão.",
      "Saltos de um tópico para outro, associações frouxas, incoerência e uso de neologismos.",
      "Mutismo e ausência de fala.",
      "Repetição de frases e palavras de outras pessoas."
    ],
    correta: "Saltos de um tópico para outro, associações frouxas, incoerência e uso de neologismos.",
    justificativa: "A fala desorganizada na esquizofrenia é marcada pela incoerência, associações frouxas, e, por vezes, pela presença de neologismos."
  },
  {
    pergunta: "O que é 'confabulação' no contexto das alterações da memória?",
    alternativas: [
      "Perda total da memória.",
      "Distorção da memória (como déjà vu).",
      "Invenção de fatos e histórias para preencher lacunas da memória, sem intenção de enganar.",
      "Lembrança de eventos futuros.",
      "Esquecimento de nomes próprios."
    ],
    correta: "Invenção de fatos e histórias para preencher lacunas da memória, sem intenção de enganar.",
    justificativa: "Confabulação é a produção de memórias falsas, geralmente para preencher lacunas de memória, sem que o indivíduo tenha consciência da falsidade."
  },
  {
    pergunta: "Qual a diferença entre 'transtorno da personalidade antissocial' e 'psicopatia', conforme o material?",
    alternativas: [
      "São termos completamente diferentes, sem relação.",
      "TPAS é um conceito mais amplo que psicopatia, que é uma subcategoria ou forma mais grave do TPAS.",
      "Psicopatia é um transtorno de ansiedade e TPAS é de humor.",
      "TPAS é um diagnóstico médico, psicopatia é um termo leigo.",
      "Psicopatia é um conceito ultrapassado, TPAS é o atual."
    ],
    correta: "TPAS é um conceito mais amplo que psicopatia, que é uma subcategoria ou forma mais grave do TPAS.",
    justificativa: "O material menciona que TPAS é a classificação formal, sendo a psicopatia, às vezes, usada como sinônimo ou para descrever uma forma mais severa."
  },
  {
    pergunta: "No tratamento da esquizofrenia, o terapeuta deve ter uma fala concreta e de fácil entendimento. Por que essa abordagem é importante?",
    alternativas: [
      "Para que o paciente se sinta desafiado intelectualmente.",
      "Para evitar que o paciente questione o terapeuta.",
      "Para se aproximar do universo e da linguagem dos pacientes, facilitando a compreensão e o engajamento.",
      "Para que o paciente se torne dependente do terapeuta.",
      "Para que o terapeuta demonstre sua superioridade intelectual."
    ],
    correta: "Para se aproximar do universo e da linguagem dos pacientes, facilitando a compreensão e o engajativa.",
    justificativa: "Uma comunicação clara e acessível é crucial para estabelecer a relação terapêutica e garantir que o paciente compreenda as intervenções."
  },
  {
    pergunta: "A 'paramnésia de reduplicação' é uma alteração da memória onde o indivíduo acredita que:",
    alternativas: [
      "Os eventos se repetiram exatamente da mesma forma.",
      "Ele já viveu aquela situação antes (déjà vu).",
      "Um local, pessoa ou evento foi duplicado ou existe em mais de um lugar ao mesmo tempo.",
      "Não consegue lembrar de nada.",
      "Pode prever o futuro."
    ],
    correta: "Um local, pessoa ou evento foi duplicado ou existe em mais de um lugar ao mesmo tempo.",
    justificativa: "A paramnésia de reduplicação envolve a crença de que algo ou alguém foi duplicado, existindo em mais de um lugar simultaneamente."
  },
  {
    pergunta: "A 'anorexia nervosa' é um transtorno alimentar grave. Qual a principal alteração psicopatológica envolvida, além da distorção da imagem corporal?",
    alternativas: [
      "Mania de limpeza.",
      "Medo irracional de lugares fechados.",
      "Um forte medo de ganhar peso e uma distorção da imagem corporal, levando a restrição alimentar extrema.",
      "Comportamento agressivo.",
      "Desejo de quebrar objetos."
    ],
    correta: "Um forte medo de ganhar peso e uma distorção da imagem corporal, levando a restrição alimentar extrema.",
    justificativa: "A anorexia nervosa é caracterizada por um medo intenso de ganhar peso e uma percepção distorcida da própria imagem corporal, levando à restrição alimentar."
  },
  {
    pergunta: "O 'delírio de grandeza' (ou megalomaníaco) é um tipo de delírio onde o indivíduo acredita que:",
    alternativas: [
      "Está sendo perseguido por inimigos.",
      "É uma pessoa extremamente importante, poderosa, rica ou possui habilidades especiais.",
      "Está sendo controlado por forças externas.",
      "Seu corpo está doente.",
      "Seus familiares foram substituídos."
    ],
    correta: "É uma pessoa extremamente importante, poderosa, rica ou possui habilidades especiais.",
    justificativa: "O delírio de grandeza é uma crença irrealista de possuir habilidades, riquezas ou poder extraordinários."
  },
  {
    pergunta: "A 'acinesia' é uma alteração da volição que se manifesta como:",
    alternativas: [
      "Aumento da atividade motora.",
      "Dificuldade em iniciar movimentos.",
      "Movimentos repetitivos e sem finalidade.",
      "Ausência total de movimento.",
      "Agitação psicomotora."
    ],
    correta: "Dificuldade em iniciar movimentos.",
    justificativa: "Acinesia é a dificuldade em iniciar e realizar movimentos, frequentemente observada em quadros parkinsonianos."
  },
  {
    pergunta: "Qual a função do 'afeto inapropriado' na esquizofrenia?",
    alternativas: [
      "Expressar emoções de forma adequada à situação.",
      "Indicar a ausência de qualquer afeto.",
      "Manifestar emoções que não condizem com o conteúdo do pensamento ou a situação (ex: rir em um velório).",
      "Ser um sintoma positivo, de adição.",
      "Aumentar a capacidade de socialização."
    ],
    correta: "Manifestar emoções que não condizem com o conteúdo do pensamento ou a situação (ex: rir em um velório).",
    justificativa: "O afeto inapropriado é a expressão de emoções que são incongruentes com a situação ou o conteúdo do pensamento."
  },
  {
    pergunta: "No contexto da psicopatologia, o que é 'dismorfofobia'?",
    alternativas: [
      "Medo de espaços abertos.",
      "Preocupação excessiva e irracional com um defeito imaginário ou leve na aparência física.",
      "Medo de ficar sozinho.",
      "Desejo de comer em excesso.",
      "Percepção de objetos gigantes."
    ],
    correta: "Preocupação excessiva e irracional com um defeito imaginário ou leve na aparência física.",
    justificativa: "Dismorfofobia é a preocupação obsessiva com um suposto defeito físico, que na maioria das vezes é imaginário ou mínimo."
  },
  {
    pergunta: "A 'esquizofrenia paranoide' é caracterizada principalmente por:",
    alternativas: [
      "Comportamento desorganizado.",
      "Delírios de perseguição ou grandeza bem sistematizados e alucinações auditivas.",
      "Predominância de sintomas negativos.",
      "Catatonia e mutismo.",
      "Afeto inapropriado e embotado."
    ],
    correta: "Delírios de perseguição ou grandeza bem sistematizados e alucinações auditivas.",
    justificativa: "A esquizofrenia paranoide se distingue pela presença de delírios e alucinações, muitas vezes com temas persecutórios ou grandiosos."
  },
  {
    pergunta: "Qual a importância da 'anamnese' no processo de avaliação psicopatológica?",
    alternativas: [
      "É um processo irrelevante.",
      "Foca apenas nos sintomas atuais do paciente.",
      "Coleta informações sobre a história de vida do paciente, histórico de sintomas, desenvolvimento e contexto social, sendo fundamental para o diagnóstico.",
      "É um processo que deve ser evitado para não influenciar o paciente.",
      "Serve apenas para preencher formulários."
    ],
    correta: "Coleta informações sobre a história de vida do paciente, histórico de sintomas, desenvolvimento e contexto social, sendo fundamental para o diagnóstico.",
    justificativa: "A anamnese é a coleta da história clínica do paciente, essencial para a compreensão de seu quadro e para o diagnóstico."
  },
  {
    pergunta: "O 'Delírio de controle' é um tipo de delírio onde o indivíduo acredita que:",
    alternativas: [
      "É uma pessoa extremamente importante.",
      "Está sendo perseguido por inimigos.",
      "Seus pensamentos, sentimentos ou ações estão sendo manipulados ou controlados por forças externas.",
      "Seus familiares foram substituídos.",
